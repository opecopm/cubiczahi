<div>
    @component('admin.partials.page.inner-header', [
        'title' => 'Team List',
        'breadcrumbs' => [['label' => 'Teams', 'active' => true]],
        'actionItems' => [[
            'type' => 'button',
            'title' => 'Add New Team',
            'wireClick' => 'openModal',
        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <input type="text" class="form-control" wire:model.live.debounce.300ms="search" placeholder="Search teams...">
                </div>
                        ...
                        <tbody>
                            @foreach($teams as $team)
                                <tr>
                                    ...
                                    <td class="text-secondary">{{ $team->description }}</td>
                                    <td class="text-secondary">{{ $team->creator->first_name ?? '' }} {{ $team->creator->last_name ?? '' }}</td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-ghost-secondary dropdown-toggle" data-bs-toggle="dropdown">Actions</button>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{ route('admin.iam.teams.show', $team->id) }}" class="dropdown-item">View</a>
                                                <button wire:click="edit('{{ $team->id }}')" class="dropdown-item">Edit</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $updateMode ? 'Edit Team' : 'Add New Team' }}</h5>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div>Do you really want to delete this team?</div>
                </div>
                <div class="modal-footer">
