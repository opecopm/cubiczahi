        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <div class="col">
                        <input type="text" class="form-control" wire:model.live.debounce.300ms="search" placeholder="Search groups...">
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach($groups as $group)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button wire:click="edit({{ $group->id }})" class="btn btn-sm btn-ghost-secondary">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div>Do you really want to delete this group?</div>
                </div>
                <div class="modal-footer">
