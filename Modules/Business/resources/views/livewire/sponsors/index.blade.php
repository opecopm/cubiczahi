<div>
    @component('admin.partials.page.inner-header', [
        'title' => 'Sponsors',
        'breadcrumbs' => [['label' => 'Sponsors', 'active' => true]],
        'actionItems' => [[
            'type' => 'button',
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            @foreach ($sponsors as $sponsor)
                                <tr>
                                    <td class="text-secondary">{{ $sponsor->id }}</td>
                                    <td class="fw-bold">{{ $sponsor->name }}</td>
                                    <td class="text-secondary">{{ $sponsor->email }}</td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-ghost-secondary dropdown-toggle" data-bs-toggle="dropdown">Actions</button>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <button wire:click="edit({{ $sponsor->id }})" class="dropdown-item">Edit</button>
                                                <button wire:click="confirmDelete({{ $sponsor->id }})"
                                                        wire:confirm="Are you sure you want to delete this sponsor?"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div>Do you really want to delete this sponsor?</div>
                </div>
                <div class="modal-footer">
