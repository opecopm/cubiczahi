<div>
    @component('admin.partials.page.inner-header', [
        ...
        'breadcrumbs' => [['label' => 'Business Partners', 'active' => true]],
        'actionItems' => [[
            'type' => 'button',
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            @foreach ($partners as $partner)
                                <tr>
                                    <td class="text-secondary">{{ $partner->id }}</td>
                                    <td class="fw-bold">{{ $partner->name }}</td>
                                    <td class="text-secondary">{{ $partner->email }}</td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-ghost-secondary dropdown-toggle" data-bs-toggle="dropdown">Actions</button>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <button wire:click="edit({{ $partner->id }})" class="dropdown-item">Edit</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $updateMode ? 'Edit Business Partner' : 'Add New Business Partner' }}</h5>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div>Do you really want to delete this partner?</div>
                </div>
                <div class="modal-footer">
