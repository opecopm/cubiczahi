<div>
                ...
                <div class="col-12 col-lg-8">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <span class="text-xs text-uppercase text-secondary font-weight-bolder d-block">Type</span>
                                    <span class="text-sm font-weight-bold">{{ \Modules\Inventory\Models\Item::TYPE_SELECT[$item->type] ?? ($item->type ?? '-') }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <span class="text-xs text-uppercase text-secondary font-weight-bolder d-block">Status</span>
                                    <span class="text-sm font-weight-bold">{{ $item->status_label ?? '-' }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <span class="text-xs text-uppercase text-secondary font-weight-bolder d-block">Category</span>
                                    <span class="text-sm font-weight-bold">{{ $item->category->name ?? '-' }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <span class="text-xs text-uppercase text-secondary font-weight-bolder d-block">Brand</span>
                                    <span class="text-sm font-weight-bold">{{ $item->brand->name ?? '-' }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <span class="text-xs text-uppercase text-secondary font-weight-bolder d-block">Model Number</span>
                                    <span class="text-sm font-weight-bold text-uppercase">{{ $item->model_number ?? '-' }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <span class="text-xs text-uppercase text-secondary font-weight-bolder d-block">Warranty (Months)</span>
                                    <span class="text-sm font-weight-bold">{{ $item->warranty_months ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-3">
                            <div class="accordion" id="itemShowDescriptionAccordion">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse-show-description-en" class="accordion-collapse collapse show"
                                ...
                                @if ($second_lang !== 'en')
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-show-description-{{ $second_lang }}">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading-show-short-en">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse-show-short-en" aria-expanded="false"
                                            aria-controls="collapse-show-short-en">
                                ...
                                @if ($second_lang !== 'en')
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-show-short-{{ $second_lang }}">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                        ...
                                        <div id="collapse-show-short-{{ $second_lang }}" class="accordion-collapse collapse"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-3">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="text-xs text-uppercase text-secondary font-weight-bolder d-block mb-1">Meta Title (EN)</div>
                                    <div class="text-sm">{{ $seo_title['en'] ?: '—' }}</div>
                                </div>
                                @if ($second_lang !== 'en')
                                    <div class="col-md-6">
                                        <div class="text-xs text-uppercase text-secondary font-weight-bolder d-block mb-1">Meta Title ({{ strtoupper($second_lang) }})</div>
                                        <div class="text-sm">{{ $seo_title[$second_lang] ?: '—' }}</div>
                                    </div>
                                @endif

                                <div class="col-md-6">
                                    <div class="text-xs text-uppercase text-secondary font-weight-bolder d-block mb-1">Meta Description (EN)</div>
                                    <div class="text-sm">{{ $seo_description['en'] ?: '—' }}</div>
                                </div>
                                @if ($second_lang !== 'en')
                                    <div class="col-md-6">
                                        <div class="text-xs text-uppercase text-secondary font-weight-bolder d-block mb-1">Meta Description ({{ strtoupper($second_lang) }})</div>
                                        <div class="text-sm">{{ $seo_description[$second_lang] ?: '—' }}</div>
                                    </div>
                                @endif

                                <div class="col-md-6">
                                    <div class="text-xs text-uppercase text-secondary font-weight-bolder d-block mb-1">Meta Keywords (EN)</div>
                                    <div class="text-sm">{{ $seo_keywords['en'] ?: '—' }}</div>
                                </div>
                                @if ($second_lang !== 'en')
                                    <div class="col-md-6">
                                        <div class="text-xs text-uppercase text-secondary font-weight-bolder d-block mb-1">Meta Keywords ({{ strtoupper($second_lang) }})</div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header p-3 d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary mb-0 d-print-none" wire:click="openPriceModal">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14"/><path d="M5 12l14 0"/></svg>
                                Add Price
                            </button>
                        </div>
                        <div class="card-body p-3">
                                ...
                                <table class="table table-vcenter card-table">
                                    ...
                                    <tbody>
                                        @foreach ($item->prices->sortByDesc('date_from') as $price)
                                            <tr>
                                                <td>{{ \Modules\Inventory\Models\ItemPrice::PRICE_SELECT[$price->price_type] ?? ucfirst($price->price_type) }}</td>
                                                <td>
                                                ...
                                                <td>{{ $price->date_from ? \Carbon\Carbon::parse($price->date_from)->format('Y-m-d') : '-' }}</td>
                                                <td>{{ $price->date_to ? \Carbon\Carbon::parse($price->date_to)->format('Y-m-d') : '-' }}</td>
                                                <td>
                                                    @if ($price->is_default)
                                                        <span class="badge bg-success-lt">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1" width="14" height="14" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: -2px;"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l5 5l10 -10"/></svg>
                                                            Default
                                                        </span>
                                                    @else
                                                ...
                                                <td class="d-print-none text-end">
                                                    <div class="d-inline-flex gap-2 flex-nowrap align-items-center">
                                                        <button type="button" class="btn btn-sm btn-outline-warning" wire:click="openPriceModal({{ $price->id }})" aria-label="Edit price">
                                                            <i class="ti ti-edit"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger" wire:click="deletePrice({{ $price->id }})" onclick="confirm('Are you sure?') || event.stopImmediatePropagation()" aria-label="Delete price">
                                        ...
                                        @if ($item->prices->isEmpty())
                                            <tr><td colspan="8" class="text-center text-secondary py-4">No price records found.</td></tr>
                                        @endif
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="card mb-4">
                            @if($item->type === 'product')
                                <div class="card-header p-3 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="btn-list d-print-none">
                                        <button type="button" class="btn btn-sm btn-outline-primary" wire:click="openSparePartsModal">
                            ...
                            @else
                                <div class="card-header p-3 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="btn-list d-print-none">
                                        <button type="button" class="btn btn-sm btn-outline-primary" wire:click="openProductsModal">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 15l6 -6"/><path d="M11 6l.463 -.536a5 5 0 0 1 7.071 7.072l-.534 .464"/><path d="M13 18l-.397 .534a5 5 0 0 1 -7.071 -7.072l.534 -.464"/></svg>
                                            Link Products
                                        </button>
                                    </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse($relatedItems as $related)
                                                <tr>
                                                    <td class="text-sm">{{ $related->model_number ?? $related->id }}</td>
                                                    <td class="text-sm">{{ $related->getTranslation('name', 'en') ?? $related->name }}</td>
                                                    <td class="text-sm">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3 text-center">
                            <div class="avatar avatar-xl position-relative">
                                <img
                                    src="{{ $item->getFirstMediaUrl('primary_photo') ? $item->getFirstMediaUrl('primary_photo') : url('assets/img/no-photo.jpg') }}"
                                    alt="item_image"
                    ...
                    <div class="card mb-4 d-print-none">
                        <div class="card-body p-3">
                                    ...
                                    <table class="table table-sm mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-sm text-end">{{ $manual->created_at?->format('Y-m-d') ?? '-' }}</td>
                                                <td class="text-end">
                                                    <a
                                                        class="btn btn-sm btn-outline-primary"
                                                        href="{{ $manual->getUrl() }}"
                            ...
                            <form wire:submit.prevent="uploadManual" class="mt-5">
                                ...
                                >
                                @error('manual_file')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror

                                <button type="submit" class="btn btn-sm btn-outline-primary mt-2 mb-0" wire:loading.attr="disabled">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                                ...
                                <li class="list-group-item border-0 d-flex align-items-center ps-0 mb-2 border-radius-lg">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-sm bg-dark-lt me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3v19"/><path d="M5 12l14 0"/></svg>
                                        </span>
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-1 text-dark text-sm">Track Inventory</h6>
                                            <span class="text-xs text-muted">{{ $item->track_inventory ? 'Enabled' : 'Disabled' }}</span>
                                        </div>
                                    </div>
                                    <div class="ms-auto">
                                        <label class="form-check form-switch m-0">
                                            <input class="form-check-input" type="checkbox" @checked($item->track_inventory) disabled>
                                        </label>
                                    </div>
                                </li>
                                <li class="list-group-item border-0 d-flex align-items-center ps-0 mb-2 border-radius-lg">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-sm bg-warning-lt me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7a5 5 0 0 1 10 0v4a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2v-4"/></svg>
                                        </span>
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-1 text-dark text-sm">Serialized</h6>
                                            <span class="text-xs text-muted">{{ $item->is_serialized ? 'Enabled' : 'Disabled' }}</span>
                                        </div>
                                    </div>
                                    <div class="ms-auto">
                                        <label class="form-check form-switch m-0">
                                            <input class="form-check-input" type="checkbox" @checked($item->is_serialized) disabled>
                                        </label>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="text-sm font-weight-bold">{{ $item->updated_at?->format('M d, Y') ?? '-' }}</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="text-sm font-weight-bold">{{ $item->createdBy->name ?? '-' }}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-sm">Updated By:</span>
                                <span class="text-sm font-weight-bold">{{ $item->updatedBy->name ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal modal-blur fade @if ($searchModal) show d-block @endif" tabindex="-1" role="dialog" style="background: rgba(0,0,0,0.5);" @if ($searchModal) aria-modal="true" @else aria-hidden="true" @endif>
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" id="search-item-modal" placeholder="Type item name or reference..." wire:model.live.debounce.500ms="itemSearch" autofocus>
                        ...
                        <div class="mt-3">
                            <ul class="list-group">
                                @foreach($itemResults as $row)
                                    ...
                                    >
                                        <span class="text-sm">{{ $row->reference }} — {{ $row->name }}</span>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-link link-secondary me-auto" wire:click="closeSearchModal">Cancel</button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal modal-blur fade @if ($sparePartsModal) show d-block @endif" tabindex="-1" role="dialog" style="background: rgba(0,0,0,0.5);" @if ($sparePartsModal) aria-modal="true" @else aria-hidden="true" @endif>
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" id="spare-part-search" placeholder="Type spare part name or reference..." wire:model.live.debounce.500ms="sparePartSearch" autofocus>
                                ...
                                @foreach($sparePartResults as $row)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <div class="text-sm">
                                            ...
                                            <div class="text-muted">{{ $row->getTranslation('name', 'en') ?? $row->name }}</div>
                                        </div>
                                        <button type="button" class="btn btn-sm btn-info mb-0" wire:click="attachSparePart({{ $row->id }})">
                                            Add
                                        </button>
                                    </li>
                                @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-link link-secondary me-auto" wire:click="closeSparePartsModal">Cancel</button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal modal-blur fade @if ($productsModal) show d-block @endif" tabindex="-1" role="dialog" style="background: rgba(0,0,0,0.5);" @if ($productsModal) aria-modal="true" @else aria-hidden="true" @endif>
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" id="product-search" placeholder="Type product name or reference..." wire:model.live.debounce.500ms="productSearch" autofocus>
                            ...
                            <ul class="list-group">
                                @foreach($productResults as $row)
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="button" class="btn btn-sm btn-info mb-0" wire:click="attachProduct({{ $row->id }})">
                                            Add
                                        </button>
                                    </li>
                                @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-link link-secondary me-auto" wire:click="closeProductsModal">Cancel</button>
                </div>
            </div>
        </div>
    </div>
