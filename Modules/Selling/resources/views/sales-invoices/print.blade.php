...
<body>
    <div class="page-header">
        <div class="top" style="display: flex; border-bottom: 2px solid #ffcc00;">
            <div class="logo" style="width: 50%; text-align:left">
                <h2 style="text-align:left">HRM Rental Co.</h2>
                <p style="text-align:left">VAT No: 123456789</p>
            </div>
            <div class="order-info" style="width: 50%;  text-align:right">
                <h2 style="text-align:right">Sales Invoice</h2>
                <p style="text-align:right">Invoice No. {{ $salesInvoice->reference }} </p>
            </div>
        </div>
        <div class="row" style="display: flex">
            <div style="width: 50%">
                ...
                <div class="customer-info customer-details">
                    ...
                    <strong>VAT No:</strong> {{ $salesInvoice->customer->vat_no }}<br>
                    <strong>CR No:</strong> {{ $salesInvoice->customer->cr_no }}<br>
                    <strong>Address:</strong> {{ $salesInvoice->customer->address }}<br>
                </div>
            </div>
            <div style="width: 50%">
                 <!-- Order Information -->
    ...
    <div class="page-footer">
        ...
        HRM Rental Co. | www.hrmrentalco.com | support@hrmrentalco.com | 123 Main St, City, Country
    </div>
                            ...
                            <table class="sales-order-table" style="margin-top: 10px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">{{ number_format($item->tax, 2) }} <br><small class="text-xs">{{$item['tax_rate']??''}} % {{$item['tax_name']??''}} </small></td>
                                ...
                                <tr>
                                    ...
                                    <td style="float:right;">
                                        <table class="table-total">
                                            ...
                                            <tr>
                                                <td><h3><strong>Total Payable:</strong></h3></td>
                                                <td><h3>{{ number_format($salesInvoice->total - ($salesInvoice->discount ?? 0), 2) }}</h3></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
