        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label for="is_rental" class="form-label">Is Rental</label>
                        <select id="is_rental" class="form-select" wire:model.live="is_rental">
                            <option value="">Select</option>
                            <option value="1">Yes</option>
                            <option value="0">No</option>
                        </select>
                        @error('is_rental')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                    </div>

                    @if ($is_rental == 1)
                        <div class="col-md-3">
                            <label for="rental_start_at" class="form-label">Rent Start Date</label>
                            <input type="date" id="rental_start_at" class="form-control" wire:model="rental_start_at">
                            @error('rental_start_at')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-3">
                            <label for="rental_end_at" class="form-label">Rent End Date</label>
                            <input type="date" id="rental_end_at" class="form-control" wire:model="rental_end_at">
                            @error('rental_end_at')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                        </div>
                    @endif
                    ...
                    <div class="col-md-3">
                        <label for="discount_rate" class="form-label">Discount</label>
