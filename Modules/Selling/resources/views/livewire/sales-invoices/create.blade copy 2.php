                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="input-group input-group-outline">
                                    ...
                                    <input type="text" id="reference" class="form-control" wire:model="reference" placeholder="{{@$nextReference}}" readonly>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group input-group-outline">
                                    ...
                                    <input type="text" class="form-control datepicker" placeholder="yyyy-mm-dd" wire:model="invoice_date">
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group input-group-outline">
                                    ...
                                    <input type="text" id="due_date" class="form-control datepicker" placeholder="yyyy-mm-dd" wire:model="due_date">
                                </div>
                            ...
                            <table class="table mt-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- Purchase Discount -->
                                        <td>
                                            @if($item['purchase_discount_type'] === 'percent')
                                                {{ number_format($item['purchase_discount'], 2) }}<br>
                                                <span class="text-xs">{{ number_format($item['purchase_discount_rate'], 2) }}%</span>
                                            @else
                                                {{ number_format($item['purchase_discount'], 2) }} (Fixed)
                                            @endif
                                        </td>

                                        <!-- Purchase Subtotal -->
                                        <td>
                                            {{ number_format($item['purchase_subtotal'], 2) }}
                                        </td>

                                        <!-- Purchase Tax -->
                                        <td>
                                            {{ number_format($item['purchase_tax_amount'], 2) }}<br>
                                            <small class="text-xs">{{ $item['purchase_tax_rate'] ?? '' }}% {{ $item['purchase_tax_name'] ?? '' }}</small>
                                        </td>

                                        <!-- Purchase Total -->
                                        <td>
                                            {{ number_format($item['purchase_total'], 2) }}
                                        </td>
