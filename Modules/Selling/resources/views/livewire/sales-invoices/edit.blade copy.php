<div class="container-fluid py-4">
    ...
    <div class="row">
        <div class="col-10 m-auto">
            <h3 class="mt-3 mb-0 text-center">Edit Invoice</h3>
            <p class="lead font-weight-normal opacity-8 mb-3 text-center">Update the details for the invoice.</p>
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="input-group input-group-outline">
                                    ...
                                    <input type="text" id="invoice_number" class="form-control" wire:model="reference" readonly>
                                </div>
                ...
                <div class="card-footer text-right">
                    <button type="submit" class="btn btn-primary btn-loading" wire:click="update">
                        Update Invoice
                    </button>
                    <a href="{{route('selling.sales-invoices.print',$salesInvoiceId)}}" target="_blank" class="btn btn-success">
                        Print Internal
                    </a>
                    <a href="{{route('selling.sales-invoices.print',$salesInvoiceId).'?copy=customer'}}" target="_blank" class="btn btn-info">
                        Print Customer Copy
                    </a>
                </div>
            </div>
