...
class Edit extends Component
{
    ...
    public function mount($salesOrderId)
    {
        ...
        $this->reference = $salesOrder->reference;
        $this->customer_id = $salesOrder->customer_id;
        $this->total_price = $salesOrder->total_price;
        $this->subtotal = $salesOrder->subtotal;
        $this->tax_id = $salesOrder->tax_id;
        $this->tax = $salesOrder->tax;
        $this->total = $salesOrder->total;
        $this->status = $salesOrder->status;
        $this->order_date = $salesOrder->order_date;
        $this->delivery_date = $salesOrder->delivery_date;
        $this->currency = $salesOrder->currency;
        $this->currency_rate = $salesOrder->currency_rate;
    ...
    public function update()
    {
        ...
        foreach ($this->items as $item) {
            SalesOrderItem::create(array_merge($item, [
    ...
    public function render()
    {
        ...
        return view('selling::livewire.sales-orders.edit', compact('units', 'customers', 'all_items', 'taxes', 'statuses'));
    }
}
