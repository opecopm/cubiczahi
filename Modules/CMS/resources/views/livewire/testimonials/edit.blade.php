    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">Update Testimonial</h2>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <button type="submit" class="btn btn-primary w-100 py-2">
                                    <i class="ti ti-device-floppy me-1"></i> Update Testimonial
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <input type="file" class="form-control @error('newImage') is-invalid @enderror" wire:model="newImage" accept="image/*">
                                <div class="mt-2">
                                ...
                                @error('newImage') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                
                                @if($newImage)
                                    <div class="mt-3 text-center border p-2 rounded bg-light">
                                        <img src="{{ $newImage->temporaryUrl() }}" alt="Preview" class="rounded border shadow-sm" style="max-height:150px; max-width: 100%;">
                                    </div>
                                @elseif($image)
                                    @php
                                        $previewUrl = str_starts_with($image, 'media-content/') ? asset($image) : asset('storage/' . $image);
                                    @endphp
                                    <div class="mt-3 text-center border p-2 rounded bg-light">
                                        <img src="{{ $previewUrl }}" alt="Current Image" class="rounded border shadow-sm" style="max-height:150px; max-width: 100%;">
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content border border-top-0 rounded-bottom p-3">
                                    ...
                                    <div class="tab-pane fade" id="video-upload-pane" role="tabpanel">
                                        ...
                                        @elseif($testimonial && $testimonial->video_path)
                                            <div class="mt-3 text-center border p-2 rounded bg-light">
                                                <video class="img-fluid rounded" style="max-height:150px;" controls>
