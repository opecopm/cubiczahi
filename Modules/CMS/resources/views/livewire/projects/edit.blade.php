    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">Edit Project: {{ $project_title[$defaultLocale] ?? 'Untitled' }}</h2>
                </div>
                <div class="col-auto ms-auto d-print-none">
                    <a href="{{ route('admin.cms.projects.index') }}" class="btn btn-outline-secondary me-2">
                                ...
                                <div class="tab-content mb-4">
                                    @foreach($languages as $locale => $label)
                                        <div class="tab-pane fade @if($locale === $defaultLocale) show active @endif"
                                            ...
                                            <!-- Additional Info (Inside Tab) -->
                                            <div class="mb-3 pt-3 border-top">
                                                <label class="form-label">Additional Information</label>
                                                <textarea wire:model.defer="additional_info.{{ $locale }}"
                                                    class="form-control" rows="3"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3" x-data="{ mainPreview: null }">
                                    ...
                                    @if($existing_main_image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $existing_main_image) }}" class="img-fluid rounded" style="max-height: 150px;">
                                ...
                                <div class="mb-3" x-data="{ iconPreview: null }">
                                    ...
                                    @if($existing_icon_image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $existing_icon_image) }}" class="img-fluid rounded" style="max-height: 50px;">
                                        </div>
                                    @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    @if(count($existing_gallery_images) > 0)
                                        <div class="d-flex flex-wrap gap-2 mb-3">
                                            @foreach($existing_gallery_images as $index => $img)
                                                <div class="position-relative">
                                                    ...
                                                    <button type="button" wire:click="removeGalleryImage({{ $index }})"
                                                        class="btn btn-danger btn-sm p-1 position-absolute top-0 end-0 rounded-circle"
                                                        style="width: 20px; height: 20px; line-height: 1; padding: 0;">&times;</button>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
