...
<div style="margin-left:calc(50% - 50vw);margin-right:calc(50% - 50vw);width:100vw;">
    <div style="background:linear-gradient(135deg,#0a2463 0%,#1565c0 60%,#0d6efd 100%); padding:36px 0 56px; position:relative; overflow:hidden;">
        <div style="position:absolute;bottom:-40px;left:0;right:0;height:60px;background:#f0f4f8;clip-path:ellipse(55% 100% at 50% 100%);"></div>
