@php
    ...
    $linkColor = $isLight ? 'rgba(255,255,255,0.78)' : '#6c757d';
    $activeColor = $isLight ? '#ffffff' : '#0a2463';
    $separatorColor = $isLight ? 'rgba(255,255,255,0.5)' : '#adb5bd';
...
<nav aria-label="breadcrumb" class="mb-3">
    <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap; font-size: 0.95rem; font-weight: 600;">
        <a href="{{ route('home') }}" wire:navigate class="text-decoration-none" style="color: {{ $linkColor }};">Home</a>
