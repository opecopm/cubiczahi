...
<head>
    ...
    {{-- Load Tajawal for RTL (Arabic), Outfit for LTR --}}
    @if($isRtl)
    ...
    @foreach($activeLanguages as $lang)
        @php $href = locale_url($lang->code); @endphp
        <link rel="alternate" hreflang="{{ $lang->code }}" href="{{ $href }}">
    @endforeach
    ...
    {{-- RTL overrides — flip Bootstrap spacing/text utilities --}}
    @if($isRtl)
    <style>
        ...
        /* push navbar toggler to the left in mobile */
