    ...
    <div class="auth-split__right">
        <div class="auth-form-wrap">
            ...
            <div class="auth-form-header" style="text-align:center;">
                <div style="width:64px;height:64px;border-radius:50%;background:linear-gradient(135deg,#059669,#064e3b);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
            ...
            <div style="text-align:center;margin-top:20px;font-size:.875rem;color:#6b7280;">
                Didn't receive a code?
                <button type="button" wire:click="resend" wire:loading.attr="disabled"
                    style="background:none;border:none;color:#059669;cursor:pointer;font-size:.875rem;padding:0;text-decoration:underline;">
            ...
            <div style="text-align:center;margin-top:12px;">
                <a href="{{ lroute('customer.login') }}" wire:navigate style="font-size:.875rem;color:#6b7280;text-decoration:none;">
                    &#8592; Back to login
                </a>
            </div>
