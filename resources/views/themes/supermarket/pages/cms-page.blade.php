...
{{-- ── Page Hero ─────────────────────────────────────────────────── --}}
<section class="page-hero" style="background: linear-gradient(135deg, #0ea5e9 0%, #0369a1 100%); padding: 5rem 0 4rem; color: white;">
        ...
        <div class="container">
            ...
            @if($section->title || $section->subtitle || $section->badge)
                <div class="text-center mb-5">
                    @if($section->badge)
                        <div class="section-label" style="text-transform: uppercase; letter-spacing: 1.5px; font-weight: 700; font-size: 0.85rem; color: #0ea5e9; margin-bottom: 0.75rem;">
                            {{ $section->badge }}
                        </div>
                    @endif
                    @if($section->title)
            ...
            @if($section->description)
                <div class="row justify-content-center mb-4">
                    <div class="col-lg-9 text-center text-muted" style="font-size: 1.05rem; line-height: 1.7;">
                        {!! \Illuminate\Support\Facades\Blade::render($section->description) !!}
                    </div>
                </div>
            @endif
                                ...
                                @switch($block->type)
                                    @case('text')
                                        <div class="text-block h-100 p-2">
                                            ...
                                            <div class="text-muted" style="line-height: 1.7;">
                                                {!! \Illuminate\Support\Facades\Blade::render($block->description) !!}
                                            </div>
                                        </div>
                                        @break
                                    ...
                                    @case('heading')
                                        <div class="heading-block text-center py-2 w-100">
                                            @if($block->badge)
                                                <div class="section-label mb-2" style="color: #0ea5e9; text-transform: uppercase; font-weight: 700; font-size: 0.8rem;">{{ $block->badge }}</div>
                                            @endif
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100 d-flex flex-column justify-content-between" style="border: 1px solid #f1f5f9;">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2 mt-2">
                                                                <div class="avatar-circle" style="width: 35px; height: 35px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background-color: #0ea5e9; color: white; font-weight: 700; font-size: 0.8rem;">
                                    ...
                                    @case('pricing')
                                        <div class="pricing-card bg-white p-4 rounded-4 shadow-sm text-center h-100 d-flex flex-column justify-content-between w-100" style="border: 1px solid #f1f5f9;">
                                            <div>
                                                ...
                                                <div class="price mb-4" style="font-size: 2.2rem; color: #0ea5e9; font-weight: 800;">
