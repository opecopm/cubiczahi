                ...
                <div class="col-lg-5 text-end">
                    @if ($item->primaryImage)
                        <img src="{{ $item->primaryImage->url }}" alt="{{ $item->getTranslation('name', 'en') }}"
                            class="w-100 rounded-4 shadow-sm mb-3 ms-auto" style="object-fit:cover;">
                    ...
                    @if ($item->images && $item->images->count() > 1)
                        <div class="d-flex gap-2 flex-wrap justify-content-end">
                            @foreach ($item->images->take(4) as $img)
                                <img src="{{ $img->url }}" alt="" class="rounded-3 object-fit-cover"
                ...
                <div class="col-lg-5">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        @if ($item->track_inventory)
                            <span class="badge bg-success-subtle text-success rounded-pill px-3 py-2">&#10003; In
                                Stock</span>
                        @endif
                        <span class="badge rounded-pill px-3 py-2" style="background:#d1fae5;color:#059669;">&#127807;
                            Eco-Friendly</span>
                        <span class="badge rounded-pill px-3 py-2" style="background:#fef3c7;color:#d97706;">&#128666; Fast
                            Shipping</span>
                    </div>
